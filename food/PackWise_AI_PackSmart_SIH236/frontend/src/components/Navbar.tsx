...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const navLinks = [
    ...
    { id: 'quantum', label: 'Quantum 3D', icon: Sliders },
    { id: 'storyboard', label: t.visualStory, icon: Film },
                ...
                <div className="absolute right-0 mt-3 w-80 rounded-xl glass-card border border-white/15 p-4 shadow-2xl z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <div className="mt-3 space-y-2.5 text-xs">
                    <div className="p-2.5 rounded-lg bg-cyan-500/10 border border-cyan-500/20 text-slate-200">
                      <p className="font-medium text-cyan-300">Mango Respiration Spike</p>
                      <p className="text-[11px] text-slate-400 mt-0.5">
                        Ambient temperature at 32°C detected in Central India hub. MAP micro-perforation advisory active.
                      </p>
                    </div>
