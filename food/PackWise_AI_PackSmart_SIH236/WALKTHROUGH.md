...
dist/assets/index-Cuu4cQHS.js   1,549.14 kB │ gzip: 414.20 kB
✓ built in 1.30s
```
...
START_PACKSMART.bat
```
Both backend and frontend will boot automatically and launch in your default web browser at `http://localhost:5173`.
