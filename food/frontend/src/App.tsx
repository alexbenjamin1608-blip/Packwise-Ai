          ...
          <>
            ...
            {activeTab === 'home' && (
              <div className="space-y-12 sm:space-y-16">
                ...
                {/* 2. Interactive 3D Packaging Laboratory */}
                <div className="pt-4">
                  <PackagingLab3D />
                </div>

                {/* 3. Barrier Analytics (OTR / WVTR) */}
                <div className="pt-4">
                  <BarrierAnalytics />
                </div>

                {/* 4. Cold Chain Logistics Tracker & Spoilage Simulator */}
                <div className="pt-4">
                  <ColdChainTracker />
                </div>

                {/* 5. Modified Atmosphere Packaging (MAP) Simulator */}
                <div className="pt-4">
                  <MapSimulator />
                </div>

                {/* 6. Mandi Spoilage & Packaging ROI Calculator */}
                <div className="pt-4">
                  <RoiCalculator />
                </div>
