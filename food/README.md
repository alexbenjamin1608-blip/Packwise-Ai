...
3. Launch the FastAPI backend on `http://localhost:8080`.
4. Launch the Vite React frontend on `http://localhost:3000`.
...
python -m uvicorn main:app --app-dir backend --host 127.0.0.1 --port 8080 --reload
```
